...
<html lang="fr">
  <head>
    ...
    <link rel="icon" href="image/logouniverscars.png">
    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div class="p-4 pt-5">
          <img src="image/logouniverscars.png" alt="logouniverscars" class="logoimage">
            ...
            <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-dark">
              <span>Espace d'administrateur</span>
     ...
     <nav class="navbar navbar-expand-lg navimg">
      ...
      <button type="button" id="sidebarCollapse" class="btn btn-outline-light">
          ...
          <a class="navbar-brand col-sm-3 col-md-2 mr-0 text-light" href="#">Univers Cars</a>
       <div class="collapse navbar-collapse" id="navbarSupportedContent">
         ...
         <ul class="nav navbar-nav ml-auto">
          ...
          <button type="submit" name="logout-admin-submit" class="btn btn-info btn-sm"><i class="fas fa-sign-out-alt"></i></button></div>
