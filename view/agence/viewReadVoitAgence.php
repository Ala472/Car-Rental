...
if (is_array($voit) || is_object($voit))
{
  ...
  <div class="card cardstyle" style="width: 19rem;">
      ...
      <!-- Button trigger modal -->
           <a href="index.php?controller=agence&action=ediit&id=<?=$voiture->id_voiture()?>" class="btn btn-light" title="Modifier"><i class="fas fa-edit"></i></a>
          ...
          <a class="btn btn-light" type="button" href="index.php?controller=agence&action=annuler&id=<?= $voiture->id_voiture() ?>" title="Annuler" onclick="return confirm('Vous avez annuler')"><i class="fas fa-window-close"></i></a>
